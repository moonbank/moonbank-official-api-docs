...
image data format like :
    "data:"+ image mine info +";base64," + image base64 data. [java demo](./src/main/java/com/moonbank/utils/Base64ImgUtil.java) [php demo](./PHP-signature-Demo/image-base64-demo.php)
